...
struct TypeDependencyNavigator {
    ...
    void instanciate_and_visit_union(UnionDefinition union_definition, const TypeSignature& concrete_type);
    void instanciate_and_visit_struct(StructDefinition struct_definition, const TypeSignature& concrete_type);
